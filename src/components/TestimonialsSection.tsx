    ...
    <section className="py-16 lg:py-24 relative overflow-hidden bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="relative mb-0 lg:mb-4 overflow-hidden">
          <div
            className="text-center font-bold text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl 2xl:text-9xl tracking-[0.05em] sm:tracking-[0.08em] lg:tracking-[0.12em] uppercase leading-none"
            style={{
          ...
          <motion.img
            src={airplaneTakeoff}
            alt="Airplane"
            className="absolute left-1/2 -translate-x-1/2 -top-1 sm:-top-2 md:-top-4 lg:-top-6 xl:-top-8 w-[50%] sm:w-[45%] md:w-[40%] lg:w-[30%] max-w-md z-10"
            animate={{ y: [0, -6, 0] }}
            ...
            <div className="relative flex-shrink-0 z-10">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <img
                    ...
                    className="w-48 h-60 sm:w-56 sm:h-72 md:w-64 md:h-80 lg:w-80 lg:h-[420px] xl:w-96 xl:h-[490px] object-cover rounded-2xl sm:rounded-3xl shadow-2xl"
                  />
                </motion.div>
              </AnimatePresence>
              ...
              <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 md:bottom-auto md:top-1/2 md:-translate-y-1/2 md:-right-16 lg:-right-28 md:left-auto md:translate-x-0 flex md:flex-col gap-2 sm:gap-3 z-20">
                <button
                  ...
                  className="w-10 h-10 sm:w-11 sm:h-11 lg:w-14 lg:h-14 rounded-full bg-white text-primary border-2 border-primary/20 flex items-center justify-center hover:bg-primary hover:text-white transition-all shadow-lg"
                >
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-3 sm:mb-4 lg:mb-6 max-sm:flex-col max-sm:text-center max-sm:gap-2">
                    ...
                    <Quote 
                      className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 text-primary max-sm:mx-auto flex-shrink-0" 
                  ...
                  <div className="flex gap-0.5 sm:gap-1 md:justify-end justify-center">
                    {[...Array(testimonials[currentIndex].rating)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-atlas-gold fill-current" />
                    ))}
                  </div>
                </motion.div>
              </AnimatePresence>
